...
import { type GetTemplateFileArgs, type InstallTemplateArgs } from './types';
...
export const installTemplate = async ({
  ...
  if (tailwind) {
    ...
    devDependencies.push('postcss', 'autoprefixer');
  }
  ...
  if (mui) {
    dependencies.push('@mui/material', '@mui/icons-material');
  }
  ...
  if (prettier) {
    devDependencies.push('prettier', '@types/prettier');
  }
